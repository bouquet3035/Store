...
<!-- 메인화면  -->
	<div id="main-content" class="col-md-8 main ">
			<div class="product">
				<div class="col-md-6">
					<div class="image">
						<center><img style="margin-top: 50px;" src="${pinfo.pimg}, " /></center>
						<div class="image-more">
							 <ul class="row">
								<li class="col-lg-3 col-sm-3 col-xs-4">
									<a href="#"><img class="img-responsive" src="${pinfo.pimg}"></a>
								</li>
								<li class="col-lg-3 col-sm-3 col-xs-4">
									<a href="#"><img class="img-responsive" src="${pinfo.pimg}"></a>
								</li>
				...
				<div class="col-md-6">
							<div class="caption ">
								...
								<div class="price">${pinfo.saleprice }원<span>${pinfo.oriprice}원</span></div>
							...
							<div class="h2" >
							<form action="/store/main" method="get"><button class="btn btn-2" >상품목록</button></form>
							</div>
							<div >
							<form action="/store/list" method="get"><input type="hidden" name="searchType" value="bpno"><input type="hidden" name="keyword" value="${pinfo.pno}">
							<button  type="submit" class="btn btn-2">구매자 검색</button></form>
							</div>
							<form method="post" id="mainForm">
								...
								제목<input type="text" class="form-control" placeholder="Username :" name="title" id="username" required  value="${pinfo.pname }같이 구매하실분 구해요 ">
								
								<br>
								내용
								<br>
								<textarea  class="form-control" name="contents" rows="3" cols="60" maxlength="500"
											placeholder="내용을 적어주세요 " id="reply">${pinfo.pname} 같이 드실분(기본메세지)</textarea>
