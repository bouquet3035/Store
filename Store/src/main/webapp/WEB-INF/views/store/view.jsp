...
<div style="border: 1px solid; width: 600px; padding: 5px">
    <form name="form1" action="/reply/*" method="post">
        <input type="hidden" name="rno" value="<c:out value="${boardInfo.tno}"/>"> 
        작성자: <input type="text" name="replyer" size="20" maxlength="20"> <br/>
        <textarea name="reply" rows="3" cols="60" maxlength="500" placeholder="댓글을 달아주세요."></textarea>
        <a href="#" onclick="/store/list">저장</a>
    </form>
</div>
...
<div class='replyDiv'>
  ...
  <script>
		function getReplies() {
			...
			var str = "";
			$.getJSON("/store/view/{rno}, function(arr) {
